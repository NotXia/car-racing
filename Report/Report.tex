...
\begin{center}
    \makebox[0cm]{
        ...
        \begin{tabular}{ |l|l| }
            ...
            \hline
            Veicolo(\underline{id}, potenza, max\_velocita) & \makecell[l]{-} \\
            \hline
            ...
            \hline
            Gara(\underline{nome}, data\_ore, num\_giri, sponsor, pista) & \makecell[l]{sponsor $\rightarrow$ Sponsor.ragione\_sociale \\ pista $\rightarrow$ Pista.nome} \\
            \hline
